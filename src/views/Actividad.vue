...
export default {
  ...
  data: () => ({
    cuestionario: {
      tema: 'Microcontroladore sensores',
      titulo: 'Cuestionario',
      introduccion:
        '<b>Objetivo:</b> evaluar comprensión el uso adecuado de las herramientas básicas en la ventana <em>Board</em> del <em>software</em> EAGLE.',
